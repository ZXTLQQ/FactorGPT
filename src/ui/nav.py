...
把原先扁平的 21 个页面按业务域整合为 6 个一级分组、二级页面挂在分组下，
...
NAV_GROUPS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"key": "gp", "label": "遗传规划挖掘", "icon": "🧬",
             "title": "遗传规划因子挖掘",
             "desc": "批量演化 + 分层多尺度挖掘 + 统计显著性检验 + 选股域对照"},
    ...
    },
    {
        ...
        "items": [
            ...
            {"key": "sys_advisor", "label": "AI 体系咨询", "icon": "🩺",
             "title": "AI 体系咨询", "desc": "基于回测事实表的对话式诊断：成色、冗余、风险集中度、权重取舍与下一步动作"},
