...
- [ ] Wire the library-level engine modules (significance gates, universe labels, parameterised operator, multi-scale GP) into the UI and cover them with tests
